...
public class GoogleAuthenticator 
{
    ...
    int window_size = 5; // default 5 - max 17 (from google docs)最多可偏移的时间  
    ...
    public static void main(String[] adfa)
    {
        //String  str = generateSecretKey();
       // System.out.println(str);
        Boolean b = authcode("726726","WI3JUJKC2KYXTA2W");
