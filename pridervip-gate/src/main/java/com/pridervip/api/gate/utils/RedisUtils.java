...
public class RedisUtils {
    ...
    @Resource(name = "redisTemplate0")//futuresPriceRedisTemplate
    private RedisTemplate<String, ?> redisTemplate0;

    @Resource(name = "redisTemplate6")//commonRedisTemplate
    ...
    private RedisTemplate<String, ?> getRedisTemplate(int index) {
        if(index==RedisIndex.COMMON.getValue()){
            return redisTemplate6;
        }else if(index==RedisIndex.PRICE.getValue()){
