...
<title>BITVC期货交易API WEB界面</title>
...
<body>
	<div id="page_head">
		<h1 class="logo l">
			<a href="https://www.bitvc.com"><b>BitVC期货</b></a>
		</h1>
		<div class="slogan">
		...
		<div id="top_bar">
            ...
            -->
				<a href="#" class="cur" id="nav_cookie_2"><i
					class="icon icon_user"></i>期货交易Api测试</a>
			</div>
		</div>
					...
					<fieldset class="fieldset_style m_b_15">
						...
						<div class="p_all_15">
							...
							<div class="group">
								<div class="col_5" align="center">
									<label class="tag m_b_15"> <input type="radio"
										name="func" value="1">查询期货资产
									</label> <label class="tag m_b_15"> <input type="radio"
										name="func" value="2">查询委托单列表
									</label> <label class="tag m_b_15"> <input type="radio"
										name="func" value="3">查询委托单详情
									</label> <label class="tag m_b_15"> <input type="radio"
										name="func" value="4">查询有效持仓列表
									</label> <label class="tag m_b_15"> <input type="radio"
										name="func" value="5">下委托单
									</label> <label class="tag m_b_15"> <input type="radio"
										name="func" value="6">取消订单
									</label>
									</label> <label class="tag m_b_15"> <input type="radio"
										name="func" value="7">持仓信息
									</label>
									 <label class="tag m_b_15"> <input type="radio"
										name="func" value="8">可用合约
									</label>
									<label class="tag m_b_15"> <input type="radio"
										name="func" value="9">资金流水
									</label>
									<label class="tag m_b_15"> <input type="radio"
										name="func" value="10">减仓单
									</label>
								</div>
							</div>
							...
							<div id="condition_div">
								...
								<div class="group">
									<label class="col_1" for="accessKey"><b class="tc_red">*</b>
										accessKey :</label>
									<div class="col_4">
										<input type="text" name="" id="accessKey"
											placeholder="accessKey" class="in_text block" />
									</div>
								</div>
								<div class="group">
									<label class="col_1" for="secretKey"><b class="tc_red">*</b>
										secretKey :</label>
									<div class="col_4">
										<input type="text" name="" id="secretKey"
											placeholder="secretKey" class="in_text block" />
									</div>
								</div>
								<div class="group">
	...
	<script type="text/javascript"
		src="<%=request.getContextPath()%>/js/indexFutures.js"></script>
	<script type="text/javascript">
		var path = "<%=path%>"+"/futures";
